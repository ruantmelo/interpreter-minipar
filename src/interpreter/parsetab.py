...
_lr_goto_items = {'stmt_block':([0,],[1,]),'seq_stmts':([0,1,],[2,6,]),'par_stmts':([0,1,],[3,7,]),'stmts':([4,5,14,],[8,27,31,]),'stmt':([4,5,8,14,27,31,58,69,85,],[9,9,28,9,28,28,73,84,86,]),'assignment':([4,5,8,14,27,31,58,69,85,],[10,10,10,10,10,10,10,10,10,]),'declaration':([4,5,8,14,27,31,58,69,85,],[11,11,11,11,11,11,11,11,11,]),'func':([4,5,8,14,27,31,32,58,69,85,],[15,15,15,15,15,15,53,15,15,15,]),'c_channel':([4,5,8,14,27,31,58,69,85,],[17,17,17,17,17,17,17,17,17,]),'b_declaration':([4,5,8,14,27,31,58,69,85,],[18,18,18,18,18,18,18,18,18,]),'s_declaration':([4,5,8,14,27,31,58,69,85,],[19,19,19,19,19,19,19,19,19,]),'i_declaration':([4,5,8,14,27,31,58,69,85,],[20,20,20,20,20,20,20,20,20,]),'condition':([29,30,],[40,50,]),'expr':([29,30,32,34,39,59,60,61,62,63,64,],[41,41,52,55,57,74,75,76,77,78,79,]),'bool_val':([29,30,],[42,42,]),'term':([29,30,32,34,39,59,60,61,62,63,64,65,66,],[45,45,45,45,45,45,45,45,45,45,45,80,81,]),'factor':([29,30,32,34,39,59,60,61,62,63,64,65,66,67,68,],[46,46,46,46,46,46,46,46,46,46,46,46,46,82,83,]),}
...
_lr_productions = [
  ...
  ('stmt_block -> seq_stmts','stmt_block',1,'p_stmt_block','parser.py',29),
  ('stmt_block -> par_stmts','stmt_block',1,'p_stmt_block','parser.py',30),
  ('stmt_block -> stmt_block seq_stmts','stmt_block',2,'p_stmt_block','parser.py',31),
  ('stmt_block -> stmt_block par_stmts','stmt_block',2,'p_stmt_block','parser.py',32),
  ('seq_stmts -> SEQ_BLOCK stmts','seq_stmts',2,'p_seq_stmts','parser.py',39),
  ('par_stmts -> PAR_BLOCK stmts','par_stmts',2,'p_par_block','parser.py',43),
  ('stmts -> stmt','stmts',1,'p_stmts','parser.py',47),
  ('stmts -> stmts stmt','stmts',2,'p_stmts','parser.py',48),
  ('stmt -> assignment','stmt',1,'p_stmt','parser.py',55),
  ('stmt -> declaration','stmt',1,'p_stmt','parser.py',56),
  ('stmt -> IF LPAREN condition RPAREN stmt','stmt',5,'p_stmt','parser.py',57),
  ('stmt -> IF LPAREN condition RPAREN stmt ELSE stmt','stmt',7,'p_stmt','parser.py',58),
  ('stmt -> WHILE LPAREN condition RPAREN stmt','stmt',5,'p_stmt','parser.py',59),
  ('stmt -> LBRACE stmts RBRACE','stmt',3,'p_stmt','parser.py',60),
  ('stmt -> func','stmt',1,'p_stmt','parser.py',61),
  ('func -> INPUT LPAREN RPAREN','func',3,'p_func','parser.py',76),
  ('func -> OUTPUT LPAREN expr RPAREN','func',4,'p_func','parser.py',77),
  ...
  ('condition -> bool_val','condition',1,'p_condition','parser.py',98),
  ('condition -> expr','condition',1,'p_condition','parser.py',99),
  ('bool_val -> TRUE','bool_val',1,'p_bool_val','parser.py',106),
  ('bool_val -> FALSE','bool_val',1,'p_bool_val','parser.py',107),
  ('assignment -> ID ASSIGN expr','assignment',3,'p_assignment','parser.py',111),
  ('assignment -> ID ASSIGN func','assignment',3,'p_assignment','parser.py',112),
  ...
  ('factor -> LPAREN expr RPAREN','factor',3,'p_factor','parser.py',134),
  ('factor -> DIGIT','factor',1,'p_factor','parser.py',135),
  ('factor -> ID','factor',1,'p_factor','parser.py',136),
  ('factor -> STRING_VALUE','factor',1,'p_factor','parser.py',137),
  ('empty -> <empty>','empty',0,'p_empty','parser.py',144),
  ('c_channel -> CHANNEL ID ID ID','c_channel',4,'p_c_channel','parser.py',148),
  ('b_declaration -> BOOL ID','b_declaration',2,'p_b_declaration','parser.py',152),
  ('s_declaration -> STRING ID','s_declaration',2,'p_s_declaration','parser.py',156),
  ('i_declaration -> INT ID','i_declaration',2,'p_i_declaration','parser.py',160),
]
